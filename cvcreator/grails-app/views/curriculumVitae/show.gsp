			...
			<ol class="property-list curriculumVitae">
				...
				<li class="fieldcontain">
					<span id="employe-label" class="property-label"><g:message code="curriculumVitae.employe.label" default="Employe" /></span>
						...
						<span class="property-value" aria-labelledby="employe-label"><g:link controller="employe" action="show" id="${curriculumVitaeInstance?.employe?.id}">${curriculumVitaeInstance?.employe?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="libellePoste-label" class="property-label"><g:message code="curriculumVitae.libellePoste.label" default="Libelle Poste" /></span>
				...
				<li class="fieldcontain">
					<span id="experiences-label" class="property-label"><g:message code="curriculumVitae.experiences.label" default="Experiences" /></span>
						...
						<span class="property-value" aria-labelledby="experiences-label"><g:link controller="experience" action="show" id="${e.id}">${e?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="formations-label" class="property-label"><g:message code="curriculumVitae.formations.label" default="Formations" /></span>
						...
						<span class="property-value" aria-labelledby="formations-label"><g:link controller="formation" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
